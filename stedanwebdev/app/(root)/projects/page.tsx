...
const page = () => {
  return (
    <main
      className="flex-grow">
      <div
        className="px-[var(--page-padding-sm)] lg:px-[var(--page-padding-lg)] pt-20">
      <Breadcrumbs />
        <div
          ...
          <p
            className="text-xl opacity-90 text-[var(--text-color)]">
            Explore my latest projects—each one is a testament to innovation, problem-solving, and passion for great design.
          </p>
        </div>
